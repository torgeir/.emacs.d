(custom-set-faces
 ...
 '(font-lock-constant-face ((t (:foreground "#a991e1"))))
 ...
 '(font-lock-string-face ((t (:foreground "#98d065"))))
 ...
 '(highlight-numbers-number ((t (:foreground "#fa9548"))))
...
(custom-set-variables
 ...
 '(helm-source-names-using-follow '("Filters/index.scss"))
 '(org-agenda-files
