(custom-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#6a9ac0"))))
 '(font-lock-doc-face ((t (:inherit font-lock-comment-face :foreground "gray60"))))
 '(font-lock-function-name-face ((t (:foreground "#e678dd"))))
 '(font-lock-keyword-face ((t (:foreground "#31afef"))))
 '(font-lock-string-face ((t (:foreground "#98c965"))))
 ...
 '(highlight-numbers-number ((t (:inherit bold :foreground "#fa9548"))))
