...
(setq +literate-config-file (concat (getenv "DOOMDIR") "/readme.org"))
...
(doom! :input
       ...
       hl-todo           ; highlight todo/fixme/note/deprecated/hack/review TODO
       ;;hydra
       ...
       :config
       literate ;; torgeir: previously rolled my own to handle DOOMLOCALDIR, git log -G DOOMLOCALDIR to find it
